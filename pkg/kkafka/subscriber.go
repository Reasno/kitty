...
func Trust() RequestResponseFunc {
	return func(ctx context.Context, message *kafka.Message) context.Context {
		return context.WithValue(ctx, kmiddleware.TrustedTransportKey, true)
	}
}
